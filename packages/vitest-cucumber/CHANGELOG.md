...
- 522f510: Fix {string} parameter matching to support apostrophes and contractions
  ...
  **Fixes matching for**:
  ...
  - @deepracticex/vitest-cucumber-plugin@1.4.3

## 1.4.2

### Patch Changes

- 278f784: Fix step definition matching to follow Cucumber standard
  ...
  **Breaking change behavior** (actually fixing non-standard behavior):
  ...
  - @deepracticex/vitest-cucumber-plugin@1.4.2

## 1.4.1

### Patch Changes

- f4ba083: Fix unhandled Promise rejection causing test process hangs
...
- Updated dependencies [f4ba083]
  - @deepracticex/vitest-cucumber-plugin@1.4.1
